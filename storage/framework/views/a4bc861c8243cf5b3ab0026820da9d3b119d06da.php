                ...
                <div class="collapse navbar-collapse" id="nav2" style="margin-right:100px">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a href="<?php echo e(URL('authentication/login')); ?>" class="nav-link mx-2 navbarFontClass mr-5 " style="color:  #023C82
                        ...
                        <?php else: ?>
                        <li class="nav-item dropdown">
                            <a href="<?php echo e(URL('/')); ?>" class="nav-link mx-2 navbarFontClass mr-5 " style="color:  #023C82
                            ; " id="nav2" href="#" id="" role="button"aria-expanded="false">
                              BACK
                            </a>
                        </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="border-top: solid 1px #023C82;border-bottom: solid 1px #023C82">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                <img class="" src="<?php echo e(asset('public/assets/web_assets/images/home/Logo1.svg')); ?>" alt="" style="height: 30px;">
            </a>
                ...
                <form class="d-flex">
                    ...
                    <div class="dropdown" style="padding-right: 14px;">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                          <li><a class="dropdown-item" href="<?php echo e(URL('/Individual-Registration')); ?>">Individual</a></li>
                          <li><a class="dropdown-item" href="<?php echo e(URL('/Business-Registration')); ?>">Business</a></li>
                          <li><a class="dropdown-item" href="<?php echo e(URL('/Accountant&Bookkeeper')); ?>">Accountant/Bookkeeper</a></li>
                        </ul>
                      </div>
                </form>
            </div>
...
<?php /**PATH C:\xampp\htdocs\app\resources\views/web/layouts/header.blade.php ENDPATH**/ ?>