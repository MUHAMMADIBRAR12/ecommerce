                            ...
                            <form name="signin" class="form" action="<?php echo e(route('create_business')); ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="<?php echo e(url('#')); ?>"><strong>Create Account</strong></a>
...
<?php echo $__env->make('web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/web/company.blade.php ENDPATH**/ ?>