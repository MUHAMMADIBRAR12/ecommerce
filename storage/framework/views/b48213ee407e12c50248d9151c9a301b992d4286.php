            ...
            <section class="wrapper">
                            <div class="">
                                <div class="text-center">
                                    <a class="navbar-brand" href="">
                                        <img class="" src="<?php echo e(asset('public/assets/images/image 1 (1).png')); ?>" alt="" >
                                    </a>
                                </div>
                            </div>
                            ...
                            <h4 class="text text-center "><b>Business Detail</b></h4>
                                ...
                                <div class="input-control form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="input-fieldd form-control"
                                        placeholder="">
                                </div>
                                <div class="input-control form-group">
                                ...
                                <div class="row">
                                    ...
                                    <a class="btn btn-primary" href="<?php echo e(url('company/login')); ?>" role="button">Next</a>
...
</html><?php /**PATH C:\xampp\htdocs\app\resources\views/web/individualbusiness.blade.php ENDPATH**/ ?>