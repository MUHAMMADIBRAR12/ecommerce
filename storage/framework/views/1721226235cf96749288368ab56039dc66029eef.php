  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg  ">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img class="" src="<?php echo e(asset('public/assets/web_assets/images/home/Back.svg')); ?>" alt="" style="height: 40px; margin-left: 30px;
                    "></a>
            </div>
        </nav>
        ...
        <div class="container-fluid loginBackground " >
           <div class="row">
                ...
                <main class="main">
                    <div class="container">
                        <section class="wrapper">
                            ...
                            <form name="signin" class="form" action="<?php echo e(route('Business-Registration-Detail')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                <img class="-mobile" src="<?php echo e(asset('public/assets/web_assets/images/home/businessDetail.svg')); ?>" alt="" style="margin-top: 120px; margin-left: 70px">
            </div>
           </div>
            <div class="container">
                <div class="text-left">
...
<?php /**PATH C:\xampp\htdocs\app\resources\views/web/Auth/businessDetail.blade.php ENDPATH**/ ?>