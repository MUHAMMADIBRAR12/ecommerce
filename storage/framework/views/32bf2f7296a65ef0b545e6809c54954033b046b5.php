        ...
        <nav class="navbar navbar-expand-lg  navvv">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img class="" src="<?php echo e(asset('public/assets/web_assets/images/Back Arrow.svg')); ?>" alt="" style="height: 40px; margin-left: 30px;
                    "></a>
            </div>
        </nav>
            ...
            <main class="main">
                <div class="container">
                    ...
                    <section class="wrapper">
                        ...
                        <form  action="<?php echo e(route('individual.register')); ?>" method="POST" class="form" >
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\app\resources\views/web/Auth/individual.blade.php ENDPATH**/ ?>